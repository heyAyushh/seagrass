...
| 24h clean fuzz run | Requires real `fuzz-readiness-<sha>.json` from `.github/workflows/fuzz.yaml`. Checked-in evidence is intentionally pending. | external blocker |
