...
Seagrass is a standalone language server and CLI for Solana Rust programs. It
owns Anchor, Pinocchio, native Solana, artifact, and security semantics while
rust-analyzer owns generic Rust.
