...
Topic: `seagrass/solana.code-quality`

Source: `seagrass`

## What It Catches

General Solana code-quality diagnostics.
...
| fixture | expected |
| --- | --- |
| `seagrass/solana.code-quality` appears only in a comment, doc comment, or string literal | no diagnostic |
...
| parsed evidence satisfies solana code quality | diagnostic |
...
```rust
// seagrass-allow: seagrass/solana.code-quality
```

File suppression:

```rust
// seagrass-allow-file: seagrass/solana.code-quality
```
...
```toml
[lints]
allow = ["seagrass/solana.code-quality"]
```
