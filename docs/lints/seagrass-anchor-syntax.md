...
Topic: `seagrass/anchor.syntax`

Source: `seagrass`

## What It Catches

Anchor parser syntax diagnostics.
...
| fixture | expected |
| --- | --- |
| `seagrass/anchor.syntax` appears only in a comment, doc comment, or string literal | no diagnostic |
...
| parsed evidence satisfies anchor syntax | diagnostic |
...
```rust
// seagrass-allow: seagrass/anchor.syntax
```

File suppression:

```rust
// seagrass-allow-file: seagrass/anchor.syntax
```
