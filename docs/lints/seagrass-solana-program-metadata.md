...
Topic: `seagrass/solana.program-metadata`

Source: `seagrass`

## What It Catches

Solana program metadata diagnostics.
...
```rust
// seagrass-allow: seagrass/solana.program-metadata
```

File suppression:

```rust
// seagrass-allow-file: seagrass/solana.program-metadata
```
...
```toml
[lints]
allow = ["seagrass/solana.program-metadata"]
```
