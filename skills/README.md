...
|---|---|---|
| [`seagrass-install`](./seagrass-install/SKILL.md) | "install seagrass", "set up seagrass", "configure seagrass in vscode/zed/vim/vi/helix/neovim" | Install binary + per-editor config + smoke check |
...
| [`seagrass-suppress`](./seagrass-suppress/SKILL.md) | "suppress this seagrass warning", "ignore this finding" | Pick narrowest correct suppression scope, including file and project switches |
