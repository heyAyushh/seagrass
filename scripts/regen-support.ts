...
const generatorSource = resolve(repoRoot, "tools/regen-support/generator.rs");
...
if (!options.anchorPath) {
  fail(
    "Missing --anchor-path.\nExample: bun scripts/regen-support.ts --anchor-path \"$SEAGRASS_ANCHOR_PATH\" --family v1",
  );
}
if (!options.family) {
  fail(
