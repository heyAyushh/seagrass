#[path = "constraint_shape/catalog.rs"]
mod catalog;
#[path = "constraint_shape/has_one.rs"]
mod has_one;
#[path = "constraint_shape/init_lifecycle.rs"]
mod init_lifecycle;
#[path = "constraint_shape/pda.rs"]
mod pda;
#[path = "constraint_shape/program_account.rs"]
mod program_account;
#[path = "constraint_shape/support.rs"]
mod support;
#[path = "constraint_shape/token.rs"]
mod token;
...
#[cfg(test)]
#[path = "constraint_shape/tests.rs"]
mod tests;
