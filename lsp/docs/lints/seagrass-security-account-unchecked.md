...
Topic: `seagrass/security.account.unchecked`

Source: `seagrass`

## What It Catches

Unchecked account security diagnostics.
...
| fixture | expected |
| --- | --- |
| `seagrass/security.account.unchecked` appears only in a comment, doc comment, or string literal | no diagnostic |
...
| parsed evidence satisfies security account unchecked | diagnostic |
...
```rust
// seagrass-allow: seagrass/security.account.unchecked
```
...
```toml
[lints]
allow = ["seagrass/security.account.unchecked"]
```
